        ...
        <div style={{ background: '#13131A', border: '1px solid rgba(212,175,55,0.15)', borderRadius: '20px', padding: '32px', boxShadow: '0 24px 64px rgba(0,0,0,0.5)' }}>
          {success ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '13px', color: '#6A6A7A' }}>Redirigiendo al dashboard...</p>
            </div>
          ) : (
            <>
              <h2 style={{ fontSize: '18px', fontWeight: '700', color: '#fff', marginBottom: '6px' }}>Nueva contraseña</h2>
              <p style={{ fontSize: '13px', color: '#6A6A7A', marginBottom: '24px' }}>Elegí una contraseña segura para tu cuenta.</p>
              <form onSubmit={handleReset}>
                ...
                <button type="submit" disabled={loading} style={{ width: '100%', marginTop: '20px', padding: '13px', borderRadius: '10px', border: 'none', cursor: 'pointer', fontSize: '14px', fontWeight: '700', fontFamily: 'inherit', background: 'linear-gradient(135deg, #D4AF37, #F5D060)', color: '#0A0A0F' }}>
