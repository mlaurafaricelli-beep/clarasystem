    ...
    <div style={{ width: '220px', minWidth: '220px', height: '100vh', background: '#13131A', borderRight: '1px solid rgba(212,175,55,0.15)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '8px', overflowY: 'auto' }}>
        ...
        {NAV.map(item => {
          ...
          return (
            <button key={item.href} onClick={() => { router.push(item.href); setOpen(false) }} style={{ width: '100%', display: 'flex', alignItems: 'center', padding: '10px 12px', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '13px', fontFamily: 'system-ui,sans-serif', fontWeight: isActive ? 600 : 400, background: isActive ? 'rgba(212,175,55,0.12)' : 'transparent', color: isActive ? '#D4AF37' : '#777', marginBottom: '2px', textAlign: 'left', gap: '8px' }}>
